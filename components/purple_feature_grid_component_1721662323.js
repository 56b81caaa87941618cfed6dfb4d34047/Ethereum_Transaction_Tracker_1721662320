...
Vue.component("purple_feature_grid_component_1721662323", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our innovative feature that allows you to monitor and receive instant notifications for new Ethereum transactions as they occur on the blockchain.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 font-medium" :class="textSecondaryStyle">Advanced Transaction Filtering</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Customize your transaction monitoring experience with robust filtering capabilities. Specify criteria such as wallet addresses, token types, or transaction values to focus on the transactions most relevant to you.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">Seamless Integration</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our seamless integration with popular wallet providers and blockchain explorers ensures a smooth and efficient workflow, allowing you to effortlessly manage and analyze new Ethereum transactions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Comprehensive Transaction Details</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain invaluable insights into each transaction with our detailed breakdown of essential information, including sender and recipient addresses, transaction values, gas fees, and more.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Built with industry-leading security practices, our platform ensures the utmost protection for your data and transactions, providing you with a reliable and trustworthy solution.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Navigate through our intuitive and user-friendly interface, designed to provide a seamless experience for both novice and experienced users alike, making it easy to track and manage new Ethereum transactions.</p></div>
        </div>
    </div>`,
        data() {
            return {
